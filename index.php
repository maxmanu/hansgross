...
<header id="miDiv" class="continer-fluid" style="background-image: url(assets/img/bg-hero-home.webp); background-repeat: no-repeat; background-size: cover">
  <div id="overlay"></div>
  <div id="contenidoDiv">
    <?php
...
<section class="section-eventos ptb-100">
  <div class="text-center mb-5">
    <h2 class="colorgreen">Eventos Académicos</h2>
...
<section class="section-certificados ptb-100">
  <div class="container">
    <div class="row">
      <div class="col-lg-4">
        <img src="assets/img/img-decor-left.png" class="card-img" alt="...">
      </div>
      ...
      <div class="col-lg-4">
        <img src="assets/img/img-decor-right.png" class="card-img" alt="...">
      </div>
    </div>
  </div>
</section>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="card-software">
                <img src="assets/img/logo-amped.png" class="card-img-top" alt="...">
              </div>
            ...
            <div class="swiper-slide">
              <div class="card-software">
                <img src="assets/img/logo-magnet.png" class="card-img-top" alt="...">
              </div>
              <div class="btn btn-arrows-servicios">
                <i class="bi bi-arrow-right"></i>
              </div>
            ...
            <div class="swiper-slide">
              <div class="card-software">
                <img src="assets/img/logo-salvation.png" class="card-img-top" alt="...">
              </div>
              <div class="btn btn-arrows-servicios">
                <i class="bi bi-arrow-right"></i>
              </div>
            ...
            <div class="swiper-slide">
              <div class="card-software">
                <img src="assets/img/logo-mobil.png" class="card-img-top" alt="...">
              </div>
              <div class="btn btn-arrows-servicios">
                <i class="bi bi-arrow-right"></i>
              </div>
            ...
            <div class="swiper-slide">
              <div class="card-software">
                <img src="assets/img/logo-3dsystems.png" class="card-img-top" alt="...">
              </div>
              <div class="btn btn-arrows-servicios">
                <i class="bi bi-arrow-right"></i>
              </div>
            ...
            <div class="swiper-slide">
              <div class="card-software">
                <img src="assets/img/logo-oxygen.png" class="card-img-top" alt="...">
              </div>
              <div class="btn btn-arrows-servicios">
                <i class="bi bi-arrow-right"></i>
              </div>
