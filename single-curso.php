...
<header id="miDiv" class="continer-fluid" style="background-image: url(assets/img/bg-single-curso.webp); background-repeat: no-repeat; background-size: cover; background-position:center;">
  <div id="overlay"></div>
      ...
      <div class="row">
        <div class="col-md-4 offset-md-8">
          <div class="card-sidebar text-center">
            <a href="#"><img src="assets/img/video-curso.jpg" alt="" class="video-image mb-3"></a>
            ...
            <div class="sidebar-feat mb-3">
              <div class="d-flex align-items-center mb-3 mx-auto">
                <div class="">
                  <img src="assets/img/icon-fecha.png" class="img-fluid me-2" alt="...">
                  <b>Fecha:</b>
                </div>
                <div class="ms-3">
              ...
              <div class="d-flex align-items-center mb-3 mx-auto">
                <div class="">
                  <img src="assets/img/icon-reloj.png" class="img-fluid me-2" alt="...">
                  <b>Horario:</b>
                </div>
              ...
              <div class="d-flex align-items-center mb-3 mx-auto">
                <div class="">
                  <img src="assets/img/icon-brochure.png" class="img-fluid me-2" alt="...">
                  <b>Brochure:</b>
                </div>
                <div class="ms-3">
                  Digital
              ...
              <div class="d-flex align-items-center mx-auto">
                <div class="">
                  <img src="assets/img/icon-diploma.png" class="img-fluid me-2" alt="...">
                  <b>Avalado:</b>
                </div>
                <div class="ms-3">
                  Hans Gross
            ...
            <a><img src="assets/img/btn-pdf.png" alt="" class="btn-pdf img-fluid mb-3"></a>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                  <span><img src="assets/img/check-svg-icon.svg" class="img-fluid me-4" style="width:25px;" alt=""></span>
                  Temario
                </button>
              </h2>
              ...
              <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse">
                <div class="accordion-body">
                  <div class="">
                    <div class="d-flex">
                      <div class="flex-shrink-0">
                        <img src="assets/img/icon-diploma.png" class="img-fluid" alt="...">
                      </div>
                  ...
                  <div class="text-center">
                    <img src="assets/img/img-tab-people.png" class="img-fluid mt-2" alt="">
                  </div>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse">
                <div class="accordion-body">
                  <div class="row align-items-center">
                    <div class="col-lg-5">
                      <img src="assets/img/yape-hansgross.png" class="img-fluid" alt="...">
                    </div>
                    <div class="col-lg-7">
                  ...
                  <div class="row mt-5">
                    <div class="col">
                      ...
                      <img src="assets/img/img-niubiz.webp" class="img-fluid" alt="...">
                    </div>
                  </div>
                </div>
              </div>
