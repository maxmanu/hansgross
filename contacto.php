...
<header id="miDiv" class="continer-fluid" style="background-image: url(assets/img/bg-hero-contacto.webp); background-repeat: no-repeat; background-size: cover; background-position:center;">
  <div id="overlay"></div>
  <div id="contenidoDiv">
    <?php
      ...
      <div class="col-lg-10 mx-auto">
        <div class="row">
          <div class="col-md-4 text-center">
            <img src="assets/img/icon-green-whatsapp.png" class="img-fluid mb-4" alt="...">
            <p class="colorgreen">+51 971 596 045</p>
          </div>
          <div class="col-md-4 text-center">
            <img src="assets/img/icon-green-email.png" class="img-fluid mb-4" alt="...">
            <p class="colorgreen">info@hansgross.com.pe</p>
          </div>
          <div class="col-md-4 text-center">
            <img src="assets/img/icon-green-map.png" class="img-fluid mb-4" alt="...">
