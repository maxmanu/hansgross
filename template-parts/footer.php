          ...
          <div class="container">
            <div class="row justify-content-around row-footer-menu">
              <div class="col-md-auto col-6">
                <p class="top-title"><a href="nosotros.php">Nosotros</a></p>
              </div>
              <div class="col-md-auto col-6">
              ...
              <div class="col-md-auto col-6">
                <p class="top-title"><a href="#">Contáctanos</a></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col">
          <div class="social-links">
            ...
            <a href="#" class="mx-2" target="_blank">
              <img src="assets/img/instagram-icon.svg" alt="" class="img-fluid">
            </a>
            <a href="#" class="mx-2" target="_blank">
              <img src="assets/img/linkedin-icon.svg" alt="" class="img-fluid">
            </a>
            <a href="#" class="mx-2" target="_blank">
              <img src="assets/img/whatsapp-icon.svg" alt="" class="img-fluid">
            </a>
          </div>
        </div>
      </div>
