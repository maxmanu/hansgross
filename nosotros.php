...
<header id="miDiv" class="continer-fluid" style="background-image: url(assets/img/bg-hero-nosotros.webp); background-repeat: no-repeat; background-size: cover">
  <div id="overlay"></div>
  <div id="contenidoDiv">
    <?php
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 offset-lg-1">
        <img src="assets/img/img-quienes-somos.webp" class="img-fluid" alt="">
      </div>
    </div>
  </div>
</section>
